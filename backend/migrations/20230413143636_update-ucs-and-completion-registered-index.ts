...
export async function down(knex: Knex): Promise<void> {
  await knex.raw(`
    CREATE INDEX IF NOT EXISTS "user_course_setting.course_id_ordered_index" ON "user_course_setting" (course_id, created_at ASC);
  `)
  await knex.raw(`
  ...
  `)
  await knex.raw(`
    CREATE INDEX IF NOT EXISTS "completion_registered.course_id_user_id_index" ON "completion_registered" (course_id, user_id);
  `)
  await knex.raw(`
