...
var seed = function () {
  return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    return tslib_1.__generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4 /*yield*/, prisma.studyModule.deleteMany({ where: {} })]
        case 1:
          _a.sent()
          return [4 /*yield*/, prisma.course.deleteMany({ where: {} })]
        case 2:
          _a.sent()
          return [
            4 /*yield*/,
          ...
          return [
            ...
            Promise.all(
              Courses.map(function (course) {
                return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                  var _course, newCourse
                  var _a, _b
                  return tslib_1.__generator(this, function (_c) {
                    switch (_c.label) {
                      case 0:
                        _course = tslib_1.__assign(
                        ...
                        return [
                          4 /*yield*/,
                          prisma.course.create({ data: _course }),
                        ]
                      case 1:
                        newCourse = _c.sent()
                        if (!course.study_modules) return [3 /*break*/, 3]
                        return [
                          4 /*yield*/,
                          prisma.course.update({
                            ...
                            data: {
                              study_modules: {
                                connect: course.study_modules.map(function (
                                  id,
                                ) {
                                  return {
                                    id: id,
