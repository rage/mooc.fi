...
import { CourseStatus, CourseTranslationWithIdInput, OpenUniversityRegistrationLinkWithIdInput } from "./globalTypes";
...
export interface updateCourse_updateCourse {
  ...
  open_university_registration_links: updateCourse_updateCourse_open_university_registration_links[] | null;
...
export interface updateCourseVariables {
  ...
  open_university_registration_links?: OpenUniversityRegistrationLinkWithIdInput[] | null;
