...
export interface CourseCreateArg {
  ...
  name?: string | null;
  new_photo?: any | null;
  open_university_registration_links?: (OpenUniversityRegistrationLinkCreateInput | null)[] | null;
  order?: number | null;
  photo?: string | null;
  ...
  study_modules?: (StudyModuleWhereUniqueInput | null)[] | null;
  support_email?: string | null;
  teacher_in_charge_email: string;
  teacher_in_charge_name: string;
  tier?: number | null;
  upcoming_active_link?: boolean | null;
  user_course_settings_visibilities?: (UserCourseSettingsVisibilityCreateInput | null)[] | null;
}
...
export interface CourseUpsertArg {
  ...
  open_university_registration_links?: (OpenUniversityRegistrationLinkUpsertInput | null)[] | null;
  order?: number | null;
  photo?: string | null;
  points_needed?: number | null;
  promote?: boolean | null;
  ...
  tier?: number | null;
  upcoming_active_link?: boolean | null;
  user_course_settings_visibilities?: (UserCourseSettingsVisibilityUpsertInput | null)[] | null;
}
...
export interface StudyModuleCreateArg {
  ...
  order?: number | null;
  slug: string;
  study_module_translations?: (StudyModuleTranslationUpsertInput | null)[] | null;
}
