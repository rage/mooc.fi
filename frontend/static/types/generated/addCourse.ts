...
import { CourseStatus, CourseTranslationCreateWithoutCourseInput, OpenUniversityRegistrationLinkCreateWithoutCourseInput } from "./globalTypes";
...
export interface addCourse_addCourse {
  ...
  open_university_registration_links: addCourse_addCourse_open_university_registration_links[] | null;
...
export interface addCourseVariables {
  ...
  open_university_registration_links?: OpenUniversityRegistrationLinkCreateWithoutCourseInput[] | null;
