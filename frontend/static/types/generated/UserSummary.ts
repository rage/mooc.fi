...
export interface UserSummary_user_user_course_summary_course {
  ...
  exercises: (UserSummary_user_user_course_summary_course_exercises | null)[] | null;
}
...
export interface UserSummary_user_user_course_summary {
  ...
  exercise_completions: (UserSummary_user_user_course_summary_exercise_completions | null)[] | null;
  user_course_progress: UserSummary_user_user_course_summary_user_course_progress | null;
  user_course_service_progresses: (UserSummary_user_user_course_summary_user_course_service_progresses | null)[] | null;
