...
You'll land into the course details page. Click on the __Download__ button for part 4, this will start a download process for part 4 exercises.
You can follow the download process by checking the __Downloaded__ counter for this part, please wait for the download process and then proceed with the instructions.
Instructions for these exercises will be in your course material.

When exercises have been downloaded, click __Open exercise workspace__ (see picture below). If this button is not visible, the workspace is already open and you can continue.
