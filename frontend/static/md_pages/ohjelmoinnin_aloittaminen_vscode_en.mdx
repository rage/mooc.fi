...
## Start programming <a name="ohjelmoinnin-aloittaminen"></a>
...
### Creating MOOC.fi account <a name="mooc.fi-tunnuksen-luominen"></a>
Go to course material and make a MOOC-fi account.

### Logging in to programming environment <a name="kirjautuminen-ohjelmointiympäristöön"></a>
...
### Selecting your organization <a name="organisaation-valinta"></a>
...
### Selecting your course <a name="kurssin-valinta"></a>
...
When you have logged in and selected the course. Click the course "Ohjelmoinnin perusteet Python, kesä 2020" in "My Courses"-view.
You land into the course details page.  
Press __Download exercises__ and you should see list of uncompleted exercises.  
Select the exercises you want to complete (at minimum osa04-01_hello_visualstudio_code). 
...
Press "Exercises" (see picture point 2), you should now see the chosen organization (hy) and course folder (hy-python-kesa-20), as well the exercises you downloaded.
Find the exercise "osa04-01_hello_visualstudio_code", under organization "hy" and course "hy-python-kesa-20".
...
Find a source code file called "hello_visualstudio_code.py".
Source code files are located in directory __"src"__.

You can open editor by clicking the exercise file hello_visualstudio_code.py.
...
### Submitting your solution to the server <a name="tehtävän-lähettäminen-palvelimelle"></a>
...
### Check your points <a name="pistetilanteen-tarkistaminen"></a>
