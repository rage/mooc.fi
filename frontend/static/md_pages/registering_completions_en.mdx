...
The credits will be registered within six weeks of enrollment. The credits will be added to the University of Helsinki study register. You will be able to view information on your course completions in the national [My Studyinfo](https://opintopolku.fi/oma-opintopolku/) service.
...
C) be a student at a [HAKA member institution](https://wiki.eduuni.fi/display/CSCHAKA/Members+and+partners).
...
Once the credits have been registered, please contact <avoin-student@helsinki.fi> and request for an official transcript of studies. When requesting an official transcript, remember to mention
...
export const meta = {
  title: "Frequenty asked questions: Registering completions",
