...
There is a version of TMCBeans you can run straight from extracted zip folder available here: [https://download.mooc.fi/tmcbeans/installers/tmcbeans.zip](https://download.mooc.fi/tmcbeans/installers/tmcbeans.zip)
