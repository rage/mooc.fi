const ohpe_image = require("./static/images/courseimages/doggos.png?resize&size=300?webp")
const fs_image = require("./static/images/courseimages/fullstack.2.png?resize&size=300?webp")
const ai_image = require("./static/images/courseimages/elements-of-ai.png?resize&size=300?webp")
const dap_image = require("./static/images/courseimages/dap.jpg?resize&size=300?webp")
const wepa_image = require("./static/images/courseimages/wepa.jpg?resize&size=300?webp")
const tilpe_image = require("./static/images/courseimages/tilpe.png?resize&size=300?webp")
const docker_image = require("./static/images/courseimages/containers.png?resize&size=300?webp")
const tikape_image = require("./static/images/courseimages/tikape.jpg?resize&size=300?webp")
const tira_image = require("./static/images/courseimages/tira.png?resize&size=300?webp")
const tito_image = require("./static/images/courseimages/tietokoneen-toiminnan-perusteet.jpg?resize&size=300?webp")
const cyber_image = require("./static/images/courseimages/cyber.png?resize&size=300?webp")
