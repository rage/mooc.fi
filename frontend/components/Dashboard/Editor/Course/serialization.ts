...
/*: (
  Omit<addCourse_addCourse, "__typename|course_translations|study_modules"> & {
    course_translations: (Omit<addCourse_addCourse_course_translations, "__typename"> | Omit<updateCourse_upadteCourse_course_translations, "__typename">)[],
    study_modules: (Omit<addCourse_addCourse_study_modules, "__typename"> | Omit<updateCourse_updateCourse_study_modules, "__typename">)[]
  } | Omit<updateCourse_updateCourse, "__typename">
) */
...
export const fromCourseForm = ({
  ...
  return {
    ...
    // @ts-ignore
*/ order:
      values.order === "" ? null : values.order,
    course_translations,
