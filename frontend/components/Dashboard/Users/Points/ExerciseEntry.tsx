  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell>
          <CollapseButton
            open={state[exerciseCompletion.exercise?.course?.id ?? "_"]?.exercises[exerciseCompletion?.exercise?.id ?? "_"] ?? false}
            onClick={() => dispatch({
      ...
      <TableRow>
        <TableCell colSpan={6}>
          <Collapse
            in={state[exerciseCompletion.exercise?.course?.id ?? "_"]?.exercises[exerciseCompletion?.exercise?.id ?? "_"] ?? false}
          >
