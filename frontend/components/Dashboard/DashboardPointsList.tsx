...
import { UserCourseSettingses_UserCourseSettingses_edges } from "/static/types/generated/UserCourseSettingses"

interface Props {
  pointsForUser: UserCourseSettingses_UserCourseSettingses_edges[]
  cutterValue: number
}
