export default {
  ...
  InstructionsEmail:
    "Use the e-mail address <strong>{{email}}</strong> on the enrollment form.",
  Instructions1: "Fill in the enrollment form.",
  Instructions2:
    "At the form field <em>Your email address on the MOOC course</em> fill in <strong>{{email}}</strong>",
  Instructions3:
    "If you want an e-mail notification when the credits have been registered, tick the box <em>A notification of completed studies will be sent to my email (including the grade)</em>.",
  NB: "<strong>NOTE!</strong> Bachelor's and Master's degree students from University of Helsinki must also register their credits via the Open University!",
