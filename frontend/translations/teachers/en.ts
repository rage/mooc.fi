export default {
  ...
  organizeText2:
    "The course package includes full course materials and exercise sets tailored for the materials. The course materials are openly readable for everyone online, but the exercises require that your students register to mooc.fi. ",
  organizeText3:
  ...
  howtoText:
    'Begin by registering to the website <a href="https://tmc.mooc.fi/">https://tmc.mooc.fi/</a>.Please make sure that your learning institution doesn\'t already have an organization.',
  howtoText2:
