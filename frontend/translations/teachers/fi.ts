export default {
  ...
  teachingTitle: "MOOCin käyttö opetuksessa",
  teachingText:
    'Voit hyödyntää suurinta osaa tarjoamistamme materiaaleista vapaasti. Materiaaleissamme on lähes poikkeuksetta käytetty <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.en">Creative Commons BY-NC-SA <a />  -lisenssiä, mutta tarkista vielä lisenssi materiaalista. Creative Commons BY-NC-SA -lisenssi tarkoittaa sitä, että voit käyttää materiaaleja joko sellaisenaan tai muokata niitä paremmin omaan opetukseesi sopivaksi, kunhan säilytät tiedon alkuperäisistä tekijöistä materiaalissa ja et tavoittele materiaaleillamme itsellesi kaupallista hyötyä. ',
  teachingText2:
  ...
  organizeTitle: "Näin järjestät kurssin",
  organizeText:
  ...
  howtoTitle: "Kurssin perustaminen",
  howtoText:
    'Aloita luomalla itsellesi käyttäjätunnus sivustolle <a href="https://tmc.mooc.fi/">https://tmc.mooc.fi/</a> Varmista ettei oppilaitoksellesi ole jo luotu organisaatiota. Mikäli oppilaitoksellasi on jo organisaatio, pyydä jotakuta organisaation opettajaa lisäämään sinut opettajaksi. Pyrimme välttämään tilannetta jossa esimerkiksi samalla lukiolla on järjestelmässä useita eri organisaatioita. ',
  howtoText2:
  ...
  tmcButtonText: "TMC Opas opettajille",
  howtoNB:
    "<b>Huom</b>: organisaatio luodaan järjestelmään välittömästi, joten voit heti organisaation luomisen jälkeen lisätä sen alle kursseja. Et kuitenkaan näe tehtävien mallivastauksia ennen kuin järjestelmänvalvoja varmistaa organisaatiosi. Järjestelyn tarkoitus on estää organisaatioiden luominen mallivastausten lunttaamiseksi. Organisaatiot hyväksytään yleensä seuraavana arkipäivänä mikäli olet käyttänyt instituutiosi sähköpostiosoitetta. Mikäli hyväksyminen kestää, ota yhteyttä sähköpostiosoitteeseemme, jonka löydät mm. tämän sivun alareunasta.",
  teachingTipsTitle: "Vinkkejä lähiopetukseen",
  teachingTips:
  ...
  "2016Title": "Opetussuunnitelma 2016",
  "2016Text":
