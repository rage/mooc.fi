export default {
  ...
  teachingText:
    "Voit hyödyntää suurinta osaa tarjoamistamme materiaaleista vapaasti. Materiaaleissamme on lähes poikkeuksetta käytetty",
  teachingText2:
    "-lisenssiä, mutta tarkista vielä lisenssi materiaalista. Creative Commons BY-NC-SA -lisenssi tarkoittaa sitä, että voit käyttää materiaaleja joko sellaisenaan tai muokata niitä paremmin omaan opetukseesi sopivaksi, kunhan säilytät tiedon alkuperäisistä tekijöistä materiaalissa ja et tavoittele materiaaleillamme itsellesi kaupallista hyötyä.",
  teachingText3:
