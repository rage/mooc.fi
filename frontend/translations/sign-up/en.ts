export default {
  ...
  emailTaken:
    "You e-mail address is already in use. Have you previously done mooc.fi courses?",
  ...
  formInfoText:
    "Here you can create a new account which works on most mooc.fi courses and services. If you have participated in mooc.fi courses before, you can use your existing account on login page.",
  error: "Error: ",
  signIn: "Already have an account? Log in.",
  confirmEmailTitle: "Your MOOC.fi account has been created.",
  confirmEmailInfo:
    "We have sent an confirmation e-mail to your e-mail address. Please check your e-mail and confirm the address.",
  submit: "Submit",
  errorResearchSubmit:
    "There was an error saving your answer. You can change it in your profile later.",
} as const
